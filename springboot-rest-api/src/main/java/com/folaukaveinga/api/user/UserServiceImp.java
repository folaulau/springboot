...
public class UserServiceImp implements UserService {
	...
	public void init() {
		for (int i = 0; i < 10; i++) {
			users.add(new User((i + 1), UUID.randomUUID(), RandomStringUtils.randomAlphabetic(15),
					RandomStringUtils.randomAlphabetic(15) + "@gmail.com", RandomStringUtils.randomAlphabetic(5)));
		}
	}
	...
	public User getById(Integer id) {
		/* test calling individual feature */
