...
public class UserLoader {
	...
	private void signup() {
		...
		signupRequest.setAge(12);
		signupRequest.setEmail("folaukaveinga@gmail.com");
		signupRequest.setName("Folau");
		signupRequest.setPassword("test");

		SessionDTO sessionDTO = userService.signUp(signupRequest);
