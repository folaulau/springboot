package com.folaukaveinga.multidbs;
...
public class SpringbootJdbcMultiDbsApplication {

	public static void main(String[] args) {
		TimeZone.setDefault(TimeZone.getTimeZone("UTC"));
		SpringApplication.run(SpringbootJdbcMultiDbsApplication.class, args);
	}
	...
	public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
		return args -> {
			...
			try {
				...
				//System.out.println("** DateTime: " + DateTimeUtils.getFormattedCurrentDateTime());
