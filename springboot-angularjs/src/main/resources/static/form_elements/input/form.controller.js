(function() {
	...
	InputController.$inject = [ '$window','$scope', '$http', '$log', '$state', 'InputService','$uibModal'];

	function InputController($window, $scope, $http, $log, $state, InputService, $uibModal) {
		$log.log("input controller");
		var form = this;
		form.data = {};
