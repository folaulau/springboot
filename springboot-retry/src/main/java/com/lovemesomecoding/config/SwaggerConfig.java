...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        Contact contact = new Contact("Social", "http://folaukaveinga.org", "folaukaveinga@gmail.com");

        return new ApiInfoBuilder().title("Social Rest API").description("Social API").version("1.0.0").contact(contact).build();
    }
