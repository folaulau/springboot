    ...
    public CommandLineRunner commandLineRunner(ApplicationContext ctx) {
        return args -> {
            ...
            try {
                ...
                System.out.println("************************ Springboot - Hasura ***************************");
                ...
                System.out.println("** Internal Url: http://" + env.getProperty("project.host") + ":8098/v1/api");
                System.out.println("** Console Url: http://" + env.getProperty("project.host") + ":8098/console");
                System.out.println("** Health Check Url: http://" + env.getProperty("project.host") + ":8098/healthz");
