...
public class SpringbootActivemqClientaApplication {

	public static void main(String[] args) {
		SpringApplication.run(SpringbootActivemqClientaApplication.class, args);
	}
	...
	class Command implements CommandLineRunner{
		...
		public void run(String... args) throws Exception {
			...
			try {
				...
				System.out.println("************************ Spring ActiveMQ Client - A ***************************");
