...
public class SwaggerConfig {
    ...
    private ApiInfo getApiInfo() {
        ...
        Contact contact = new Contact("GraphQL", "https://lovemesomecoding.com", "folaudev@gmail.com");

        return new ApiInfoBuilder().title("GraphQL Rest API").description("GraphQL API").version("1.0.0").contact(contact).build();
    }
